...
images_recs = st.sidebar.slider(label = 'Reverse Image Search - Select an image from the index', min_value = 0,
                          max_value = 5400,
                          value = 150,
                          step = 1)
...
input = st.sidebar.text_input('Reverse Text Search - Enter animal name using text', 'Dog')
